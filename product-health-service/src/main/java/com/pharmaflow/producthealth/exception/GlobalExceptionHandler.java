package com.pharmaflow.producthealth.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleValidationExceptions(
        ...
        return buildErrorResponse(HttpStatus.BAD_REQUEST, "Validation Error",
                "Request validation failed. Check 'errors' for details.", request.getRequestURI(), fieldErrors);
    }
    ...
    public ResponseEntity<Map<String, Object>> handleConstraintViolation(
        ...
        return buildErrorResponse(HttpStatus.BAD_REQUEST, "Constraint Violation",
                "Request constraints violated. Check 'errors' for details.", request.getRequestURI(), violations);
    }
    ...
    public ResponseEntity<Map<String, Object>> handleDataIntegrityViolation(
        ...
        logger.error("Data integrity violation on {}: {}", request.getRequestURI(),
    ...
    public ResponseEntity<Map<String, Object>> handleHttpMessageNotReadable(
        ...
        return buildErrorResponse(HttpStatus.BAD_REQUEST, "Malformed Request",
                "Request body is malformed or invalid JSON format.", request.getRequestURI(), null);
    }
    ...
    public ResponseEntity<Map<String, Object>> handleMethodNotSupported(
        ...
        String message = String.format("HTTP method '%s' is not supported. Supported: %s",
    ...
    public ResponseEntity<Map<String, Object>> handleUnsupportedMediaType(
        ...
        String message = String.format("Media type '%s' is not supported. Supported: %s",
