...
class TherapyControllerTest {
    ...
    void createTherapy() throws Exception {
        ...
        mockMvc.perform(post("/api/therapies").contentType(MediaType.APPLICATION_JSON).content(objectMapper.writeValueAsString(testTherapyDTO))).andExpect(status().isCreated());
