...
public class StartupSummaryLogger {
    ...
    public void logStartupSummary() {
        ...
        logDatabaseStatus();
        log.info("Modules: products, categories, substances, interactions, contraindications, substitutes");
        log.info("Demo catalog: 100 generated products seeded on startup when profile is not test");
        log.info(
    ...
    private String appName() {
        return environment.getProperty("spring.application.name", "product-health-service");
    }

    private String port() {
        return environment.getProperty("server.port", "8083");
    }
