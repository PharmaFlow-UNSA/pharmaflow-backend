...
public class FaqService {
    ...
    public FaqService(FaqEntryRepository faqEntryRepository, FaqMapper faqMapper) {
    ...
    public FaqEntryResponseDto createFaqEntry(FaqEntryRequestDto requestDto) {
        ...
        return faqMapper.toResponseDto(faqEntryRepository.save(faqEntry));
    }
    ...
    private void ensureQuestionUnique(String normalizedQuestion, Long currentId) {
        boolean duplicateExists = currentId == null
                ...
                : faqEntryRepository.existsByNormalizedQuestionAndFaqIdNot(normalizedQuestion, currentId);
