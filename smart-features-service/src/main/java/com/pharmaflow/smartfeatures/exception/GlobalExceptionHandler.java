...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handleDataIntegrityViolation(
        ...
        } else if (causeMessage != null && causeMessage.toLowerCase().contains("normalized_rule_name")) {
            message = "A fraud rule with the same name already exists.";
        } else if (causeMessage != null && causeMessage.toLowerCase().contains("uk_symptom_search_item_search_symptom")) {
        ...
        } else if (causeMessage != null && causeMessage.toLowerCase().contains("active_dimension_key")) {
            message = "An active recommendation with the same dimensions already exists.";
        }
