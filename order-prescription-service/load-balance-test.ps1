# Load Balance Test Script - Order & Prescription Service
# Tests load balancing by sending 100 requests through Eureka and tracking instance distribution

Write-Host "===================================================" -ForegroundColor Green
Write-Host "  Load Balancing Test - Order & Prescription Service" -ForegroundColor Green
Write-Host "===================================================" -ForegroundColor Green
Write-Host ""

$numberOfRequests = 100
$baseUrl = "http://localhost:8087/api/load-balancer-demo"
$results = @{}
