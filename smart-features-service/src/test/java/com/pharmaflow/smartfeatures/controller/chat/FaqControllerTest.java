...
class FaqControllerTest {
    ...
    void getFaqEntriesShouldReturn200() throws Exception {
        ...
        mockMvc.perform(get("/api/faqs").contentType(MediaType.APPLICATION_JSON))
    ...
    void searchFaqEntriesShouldRejectShortQueryAtWebLayer() throws Exception {
        mockMvc.perform(get("/api/faqs/search").param("query", "a").contentType(MediaType.APPLICATION_JSON))
